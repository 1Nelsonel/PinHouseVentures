...
class Property(models.Model):
    ...
    #images
    imageOne = models.ImageField(upload_to='upload/property_images', null=True)
    imageTwo = models.ImageField(upload_to='upload/property_images', null=True)
    imageThree = models.ImageField(upload_to='upload/property_images', null=True)
    imageFour = models.ImageField(upload_to='upload/property_images', null=True)
    imageFive = models.ImageField(upload_to='upload/property_images', null=True)
    description = models.TextField(null=True)
    #amenities
